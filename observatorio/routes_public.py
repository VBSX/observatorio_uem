...
# Para a funcionalidade de login, instale a Authlib: pip install Authlib
...
def register_public_routes(app, limiter):
    ...
    def submit():
        ...
        if request.method == 'POST':
            ...
            # Define o user_id como o ID do usuário logado ou None se for anônimo
